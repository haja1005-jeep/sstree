...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        // [수정] INSERT 쿼리에 establishment_year, management_agency 추가
    ...
    <form method="POST" action="" enctype="multipart/form-data">
        ...
        <div class="form-section dynamic-field" id="area-section">
            ...
            <div class="form-group">
                ...
                <div class="help-text">공원, 생활숲, 도시숲인 경우 입력</div>
            </div>
        </div>
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="road_type" 
                           placeholder="예: 국도, 지방도, 군도, 면도 등"
                           value="<?php echo isset($_POST['road_type']) ? htmlspecialchars($_POST['road_type']) : ''; ?>">
                </div>
            </div>
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="number" name="establishment_year" min="1900" max="2100" 
                           placeholder="예: 2020"
                           value="<?php echo isset($_POST['establishment_year']) ? $_POST['establishment_year'] : ''; ?>">
                </div>
                <div class="form-group">
                    <label>관리기관</label>
                    <input type="text" name="management_agency" 
                           placeholder="예: 신안군 산림과"
                           value="<?php echo isset($_POST['management_agency']) ? htmlspecialchars($_POST['management_agency']) : ''; ?>">
                </div>
            </div>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                <label>일반 사진 (다중 선택 가능, 최대 <?php echo (MAX_FILE_SIZE / 1024 / 1024); ?>MB)</label>
            ...
            <div class="form-group">
                <label>360도 VR 사진 (최대 <?php echo (MAX_FILE_SIZE / 1024 / 1024); ?>MB)</label>
